...
"""
def new_output_entry(output_file,string):
    with open(output_file, "a") as f:
        f.write(string)

def new_temp_output_entry(string, ml, cat, par_num, text, z):
...
def main(anchor_file, truncate_dir, output_file):
    ...
    with open(anchor_file) as f:
        ...
        #skip over non LER files file and display the correct error message and file output
            ...
            if filename.startswith('i', 0, 2) == False and filename.startswith('o',0,2) == False:
                if filename in filenames:
                    ...
                    for z in range(0,5):
                        ...
                        for dict in anchor:
                            ...
                            # Choose longest extracted text

                            if len(strip_tags(extracted_1))>len(strip_tags(extracted)):
                        ...
                        final_extraction = new_temp_output_entry(final_extraction, ml, cat, 1, strip_tags(extracted), z)

                    if checker == 1:
                        continue
                    else:
                        new_output_entry(output_file, final_extraction)
